...
<div class="sidebar">
    ...
    <div class="content">
        ...
        <div class="stats-section">
            <div class="stat-box">Projets finis:<?php echo $pas_comm["projet_pas_commence"]; ?></div>
            <div class="stat-box">Projets en cours: <?php echo $encour["projet_encour"]; ?></div>
            <div class="stat-box">Projets non commencés: <?php echo $finies["projet_fini"]; ?></div>
        </div>
        ...
        <div class="add-project">
            <form action="index.php?action=search_projects" method="post">
                <input type="text" name="search_query" class="search_bar" placeholder="Rechercher un projet...">
                <button type="submit" class="search_button">&#128269;</button>
            </form>
            <a href="index.php?action=add_project_page"><button class="add-project-button">+ Add Project</button></a>
        </div>
            ...
            <?php foreach($project_info as $info) { ?>
                <div class="project-box">
                    ...
                    <div class="update_buttons">
                        ...
                        <a href="index.php?action=delet_project&id_projet=<?php echo $info["id_projet"]; ?>"><button class="supprimer_button">supprimer</button></a>
                    </div>
                </div>
            <?php } ?>
        </div>
