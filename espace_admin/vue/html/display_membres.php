                ...
                <tbody>
                    <?php foreach ($membres as $m) { // ?>
                        <tr>
                            ...
                            <td><a href="index.php?action=update_member_page&id=<?php echo $m["id_user"]; ?>"><button>update</button></a></td>
                            <td><a href="index.php?action=delete_member&id=<?php echo $m["id_user"]; ?>"><button>delete</button></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
