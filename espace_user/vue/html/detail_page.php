    ...
    function checkTaches() {
        ...
        <div class="main-content">
            ...
            <div class="tasks-table">
                ...
                <a href="index.php?action=add_tache_page&id_project=<?php echo $id_project; ?>"><button>+ ajouter tache</button></a>
                <table>
                    <thead>
                        <tr>
                            <th>Nom</th>
                    ...
                    <tbody>
                        <?php foreach($taches as $t) {?>
                            <tr>
                                ...
                                <td><a href="index.php?action=update_tache_page&id_tache=<?php echo $t["id_tache"]; ?>&id_project=<?php echo $id_project; ?>"><button>modifier</button></a></td>
                                <td><a href="index.php?action=delete_tache&id_tache=<?php echo $t["id_tache"]; ?>&id_project=<?php echo $id_project; ?>"><button>supprimer</button></a></td>
                            </tr>
                        <?php }?>
                    </tbody>
                </table>
