...
// $project=new project_transaction;
    ...
    switch($action){
        ...
        //     $search_query = isset($_POST['search_query']) ? $_POST['search_query'] : '';$id_chef = isset($_GET['id_chef']) ? $_POST['id_chef'] : '';
        ...
        case 'update_tache_page' : $id_tache=$_GET["id_tache"]; $controller->update_tache_page($id_tache); break;

        case 'update_tache' : $id_tache=$_GET["id_tache"]; $controller->update_tache($id_tache); break;
        ...
        // case 'ajouter_tache' : $id_project=$_GET["id_project"]; $controller->ajouter_tache($id_project); break;

        case 'display_taches' : $id_membre=$_GET["id_membre"]; $controller->afficher_taches($id_membre);break;
