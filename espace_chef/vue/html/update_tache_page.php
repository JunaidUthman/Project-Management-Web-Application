...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="index.php?action=update_tache&id_tache=<?php echo $id_tache;?>&id_project=<?php echo $id_project;?>" method="POST">
                <div class="form-content">
                    <div class="form-left">
                        <div class="input-group">
                            <label for="nom_projet">Nom du Projet</label>
                            <input type="text" id="nom_projet" name="nom_tache" value="<?php echo $info_tache["nom_tache"]; ?>" required>
                        </div>

                        <div class="input-group">
                            <label for="description_projet">Description</label>
                            <textarea id="description_projet" name="description_tache" rows="5"  required><?php echo $info_tache["description_tache"]; ?></textarea>
                        </div>

                        <div class="input-group">
                            <label for="date_debut_projet">Date de Début</label>
                            <input type="date" id="date_debut_projet" name="date_debut_tache" value="<?php echo $info_tache["date_debut_tache"]; ?>" required>
                        </div>

                        <div class="input-group">
                            <label for="date_fin_projet">Date Prévue</label>
                            <input type="date" id="date_fin_projet" name="date_prévue_tache" value="<?php echo $info_tache["date_prévue_tache"]; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-right">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" id="date_fin_projet" name="date_fin_tache" value="<?php echo $info_tache["date_fin_tache"]; ?>" required>
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <select id="statut_projet" name="priorite_tache">
                                <option value="pas commence">Haute</option>
